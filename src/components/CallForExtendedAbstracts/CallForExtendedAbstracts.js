...
export default function CallForExtendedAbstracts() {
    ...
    return (
        <div className="CallForExtendedAbstracts bg-white overflow-hidden w-100">
            <img className="ConferenceTracks-2 d-none d-lg-block w-25" src={ConferenceTracks} alt="ConferenceTracksImg"/>
            <img src={headerImg} className="img-fluid"/>
            <div className="container">
                <div className="row">
                    <h3 className="text-center text-uppercase w-100 section-title">Conference Tracks</h3>
                    <div className="col-12">
                        <div className="p-tracks text-center mx-auto">
